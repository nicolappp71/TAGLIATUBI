...
// "<div class='links'>"
// "<a href='/settings' class='settings-link'>⚙️ Impostazioni</a>"
...
// "h1{color:#e94560;margin-bottom:30px;text-align:center;font-size:2em}"
...
// "<div class='setting-group' style='margin-top:30px'>"
// "<label class='setting-label'>🗑️ Segnala Scarti</label>"
...
// "<button class='btn' style='margin-top:15px;background:linear-gradient(90deg,#e74c3c,#c0392b)' onclick='reportScrap()'>🗑️ Segnala Scarti</button>"
// "</div>"
...
// "if(!qta||qta<1||qta>9999){statusScrap.className='status error';statusScrap.textContent='✗ Inserisci quantità valida (1-9999)';return;}"
...
//     ESP_LOGI(TAG, "✓ Server HTTP avviato (Task su Core 1)");
//     ESP_LOGI(TAG, "📡 Dashboard: http://<IP>/");
//     ESP_LOGI(TAG, "⚙️  Settings: http://<IP>/settings");
//     ESP_LOGI(TAG, "📋 Logs: http://<IP>/logs");
//     ESP_LOGI(TAG, "🔌 API Data: http://<IP>/api/data");
//     ESP_LOGI(TAG, "🔌 API Logs: http://<IP>/api/logs");
//     ESP_LOGI(TAG, "🔌 API Settings: http://<IP>/api/settings");
//     ESP_LOGI(TAG, "🔌 API Scatola: http://<IP>/api/scatola");
//     ESP_LOGI(TAG, "🔌 API Login: http://<IP>/api/login");
//     ESP_LOGI(TAG, "🔌 API Scarto: http://<IP>/api/scarto");
//     ESP_LOGI(TAG, "⏱️  Aggiornamento: 500ms / 1s logs");
//     ESP_LOGI(TAG, "");
